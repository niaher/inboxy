...
/* src\core\ui\inputs\Text.html generated by Svelte v1.56.0 */
...
/* src\core\ui\inputs\Number.html generated by Svelte v1.56.0 */
...
/* src\core\ui\inputs\Date.html generated by Svelte v1.56.0 */
...
/* src\core\ui\inputs\Dropdown.html generated by Svelte v1.56.0 */
...
function create_each_block(component, state) {
	var option = state.option, option_index = state.option_index;
...
/* src\core\ui\inputs\Boolean.html generated by Svelte v1.56.0 */
...
/* src\core\ui\inputs\MultiSelect.html generated by Svelte v1.56.0 */
...
/* src\core\ui\inputs\Password.html generated by Svelte v1.56.0 */
...
/* src\core\ui\inputs\Textarea.html generated by Svelte v1.56.0 */
...
/* src\core\ui\inputs\FileUploader.html generated by Svelte v1.56.0 */
var methods = {
	addFiles(files) {
		var field = this.get("field");
...
function create_each_block$1(component, state) {
	var file = state.file, file_index = state.file_index;
...
/* src\core\ui\outputs\Text.html generated by Svelte v1.56.0 */
...
/* src\core\ui\outputs\Number.html generated by Svelte v1.56.0 */
...
/* src\core\ui\outputs\Datetime.html generated by Svelte v1.56.0 */
...
/* src\core\ui\Output.html generated by Svelte v1.56.0 */
function data() {
    return {
        showLabel: true
    };
...
/* src\core\ui\outputs\Table.html generated by Svelte v1.56.0 */
...
function create_each_block_1(component, state) {
	var row = state.row, row_index = state.row_index;
	var tr;

	var columnsOrdered = state.columnsOrdered;

	var each_blocks = [];

	for (var i = 0; i < columnsOrdered.length; i += 1) {
		each_blocks[i] = create_each_block_2(component, assign({}, state, {
			column: columnsOrdered[i],
			column_index: i
		}));
	}
	...
	return {
		...
		p: function update(changed, state) {
			...
			if (changed.getField || changed.field || changed.columnsOrdered || changed.app || changed.form || changed.parent) {
				...
				each_blocks.length = columnsOrdered.length;
			}
		},
...
function create_each_block_2(component, state) {
	var row = state.row, column = state.column, row_index = state.row_index, column_index = state.column_index;
	var td;
...
/* src\core\ui\outputs\FormLink.html generated by Svelte v1.56.0 */
...
/* src\core\ui\outputs\Tabstrip.html generated by Svelte v1.56.0 */
...
function create_each_block$3(component, state) {
	var tab = state.tab, tab_index = state.tab_index;
...
function create_each_block_1$1(component, state) {
	...
	for (var i = 0; i < columnsOrdered.length; i += 1) {
		each_blocks[i] = create_each_block_2$1(component, assign({}, state, {
			column: columnsOrdered[i],
			column_index: i
		}));
	}
...
function create_if_block$6(component, state) {
	...
	for (var i = 0; i < columnsOrdered.length; i += 1) {
		each_blocks[i] = create_each_block$5(component, assign({}, state, {
			column: columnsOrdered[i],
			column_index: i
		}));
	}
...
/* src\core\ui\outputs\Paginator.html generated by Svelte v1.56.0 */
...
function create_each_block$4(component, state) {
	var page = state.page, page_index = state.page_index;
	var if_block_anchor;
...
function create_if_block_2$1(component, state) {
	...
	return {
		...
		p: function update(changed, state) {
			...
			button._svelte.pages = state.pages;
	...
	return {
		...
		p: function update(changed, state) {
			...
			if (changed.parent || changed.app || changed.form || changed.pages) {
				...
				each_blocks.length = pages.length;
			}
		},
...
function click_handler(event) {
	...
	var pages = this._svelte.pages, page_index = this._svelte.page_index, page = pages[page_index];
...
/* src\core\ui\Input.html generated by Svelte v1.56.0 */
var inputId = 0;
...
/* src\core\ui\help\Help.html generated by Svelte v1.56.0 */
function data$5() {
	return {
		document: null
	}
...
function encapsulateStyles$10(node) {
	setAttribute(node, "svelte-4034064174", "");
}

function add_css$10() {
	var style = createElement("style");
	style.id = 'svelte-4034064174-style';
	style.textContent = "[svelte-4034064174].tooltip,[svelte-4034064174] .tooltip{opacity:1;display:inline;margin:10px;font-weight:700;position:relative}[svelte-4034064174].inline-help,[svelte-4034064174] .inline-help{background:#ecf8fb;padding:10px}";
	appendNode(style, document.head);
}
...
function create_main_fragment$21(component, state) {
	...
	var if_block = (state.document != null) && create_if_block$10(component, state);
...
// (4:4) {{ #if document.sourceType == 'String'}}
function create_if_block_2$4(component, state) {
	var span, span_aria_label_value;
	...
	return {
		...
		h: function hydrate() {
			...
			setAttribute(span, "aria-label", span_aria_label_value = state.document.source);
		},
		...
		p: function update(changed, state) {
			if ((changed.document) && span_aria_label_value !== (span_aria_label_value = state.document.source)) {
				setAttribute(span, "aria-label", span_aria_label_value);
			}
		},
...
function create_if_block_3$1(component, state) {
	...
	return {
		...
		h: function hydrate() {
			encapsulateStyles$10(a);
			a.href = a_href_value = "/#/form/help?FileId=" + state.document.source;
			a.className = "tooltip bottom";
			setAttribute(a, "aria-label", "Help?");
		},
		...
		p: function update(changed, state) {
			if ((changed.document) && a_href_value !== (a_href_value = "/#/form/help?FileId=" + state.document.source)) {
				a.href = a_href_value;
			}
		},
...
// (17:4) {{ #if document.sourceType == 'String' }}
function create_if_block_5(component, state) {
	var p, raw_value = state.document.source;
	...
	return {
		...
		p: function update(changed, state) {
			if ((changed.document) && raw_value !== (raw_value = state.document.source)) {
				p.innerHTML = raw_value;
			}
		},
...
// (3:3) {{ #if document.placement == 'Hint' }}
...
function select_block_type$7(state) {
	if (state.document.sourceType == 'String') return create_if_block_2$4;
	return create_if_block_3$1;
}

function select_block_type_1(state) {
	if (state.document.sourceType == 'String') return create_if_block_5;
	return create_if_block_6;
}

function select_block_type_2(state) {
	if (state.document.placement == 'Hint') return create_if_block_1$8;
	if (state.document.placement == 'InlineDescription') return create_if_block_4;
...
function SvelteComponent$21(options) {
	...
	if (!document.getElementById("svelte-4034064174-style")) add_css$10();
...
/* src\core\ui\Form.html generated by Svelte v1.56.0 */
let tabindex = 1;
var openForms = [];
...
function create_main_fragment$19(component, state) {
	...
	var if_block = (state.initialized && state.documentation) && create_if_block$8(component, state);

	var if_block_1 = (state.initialized && state.visibleInputFields.length > 0) && create_if_block_1$6(component, state);

	var if_block_2 = (state.outputFieldValues != null) && create_if_block_2$3(component, state);
	...
	return {
		...
		p: function update(changed, state) {
			...
			if (state.initialized && state.documentation) {
				if (if_block) {
					if_block.p(changed, state);
				} else {
			...
			if (state.outputFieldValues != null) {
				if (if_block_2) {
					...
					if_block_2 = create_if_block_2$3(component, state);
					if_block_2.c();
...
function create_if_block$8(component, state) {
	...
	return {
		...
		p: function update(changed, state) {
			var help_changes = {};
			if (changed.documentation) help_changes.data = state.documentation;
...
// (12:1) {{#each visibleInputFields as inputField}}
function create_each_block$7(component, state) {
	var inputField = state.inputField, inputField_index = state.inputField_index;
...
// (9:0) {{#if initialized && visibleInputFields.length > 0}}
function create_if_block_1$6(component, state) {
	...
	for (var i = 0; i < visibleInputFields.length; i += 1) {
		each_blocks[i] = create_each_block$7(component, assign({}, state, {
			inputField: visibleInputFields[i],
			inputField_index: i
		}));
	}
...
// (23:1) {{#each outputFieldValues as outputField}}
function create_each_block_1$2(component, state) {
	var outputField = state.outputField, outputField_index = state.outputField_index;
	var if_block_anchor;

	var if_block = (outputField.metadata.hidden == false) && create_if_block_3(component, state);
...
// (24:1) {{#if outputField.metadata.hidden == false}}
...
// (21:0) {{#if outputFieldValues != null}}
function create_if_block_2$3(component, state) {
	...
	for (var i = 0; i < outputFieldValues.length; i += 1) {
		each_blocks[i] = create_each_block_1$2(component, assign({}, state, {
			outputField: outputFieldValues[i],
			outputField_index: i
		}));
	}
...
/* src\core\ui\outputs\ActionList.html generated by Svelte v1.56.0 */
var modalId = 0;
var modals = [];
...
function create_each_block$6(component, state) {
	var action = state.action, action_index = state.action_index;
	...
	return {
		...
		p: function update(changed, state) {
			...
			button._svelte.actions = state.actions;
...
function create_if_block$7(component, state) {
	...
	for (var i = 0; i < actions.length; i += 1) {
		each_blocks[i] = create_each_block$6(component, assign({}, state, {
			action: actions[i],
			action_index: i
		}));
	}
...
/* src\core\ui\outputs\InlineForm.html generated by Svelte v1.56.0 */
function oncreate$7() {
	var app = this.get("app");
	var field = this.get("field");
	var parentFormComponent = this.get("parent");
...
/* src\core\ui\outputs\TextValue.html generated by Svelte v1.56.0 */
...
/* src\core\ui\outputs\DownloadableFile.html generated by Svelte v1.56.0 */
...
/* src\core\ui\outputs\Alert.html generated by Svelte v1.56.0 */
...
function create_if_block$11(component, state) {
	...
	var if_block = (state.field.data.heading != null) && create_if_block_1$9(component, state);

	var if_block_1 = (state.field.data.message != null) && create_if_block_2$5(component, state);
...
/* src\core\ui\outputs\FileSize.html generated by Svelte v1.56.0 */
...
/* src\core\ui\outputs\Image.html generated by Svelte v1.56.0 */
...
/* src\core\ui\outputs\Link.html generated by Svelte v1.56.0 */
function create_main_fragment$28(component, state) {
	var if_block_anchor;

	var if_block = (state.field.data != null) && create_if_block$13(component, state);
...
/* src\core\ui\outputs\ObjectList.html generated by Svelte v1.56.0 */
function oncreate$8() {
	var field = this.get("field");
...
function create_main_fragment$29(component, state) {
	...
	var if_block = (state.items != null) && create_if_block$14(component, state);
...
function create_each_block$8(component, state) {
	var itemFields = state.itemFields, itemFields_index = state.itemFields_index;
	var div;
	...
	for (var i = 0; i < itemFields.length; i += 1) {
		each_blocks[i] = create_each_block_1$3(component, assign({}, state, {
	...
	return {
		...
		p: function update(changed, state) {
			...
			if (changed.items || changed.app || changed.form || changed.parent) {
				...
				each_blocks.length = itemFields.length;
			}
		},
...
function create_each_block_1$3(component, state) {
	var itemFields = state.itemFields, itemField = state.itemField, itemFields_index = state.itemFields_index, itemField_index = state.itemField_index;
	var if_block_anchor;

	var if_block = (itemField.metadata.hidden == false) && create_if_block_1$10(component, state);
...
function create_if_block$14(component, state) {
	...
	for (var i = 0; i < items.length; i += 1) {
		each_blocks[i] = create_each_block$8(component, assign({}, state, {
			itemFields: items[i],
			itemFields_index: i
		}));
	}
...
/* src\core\ui\outputs\EmailBody.html generated by Svelte v1.56.0 */
...
/* src\core\ui\outputs\RawHtml.html generated by Svelte v1.56.0 */
...
/* src\components\MenuItem.html generated by Svelte v1.56.0 */
let id = 0;
function data$6() {
	return {
		id: id++
...
function create_each_block$10(component, state) {
	var submenu = state.submenu, submenu_index = state.submenu_index;
	var li;
...
function create_if_block_2$6(component, state) {
	...
	for (var i = 0; i < items.length; i += 1) {
		each_blocks[i] = create_each_block$10(component, assign({}, state, {
			submenu: items[i],
			submenu_index: i
		}));
	}
...
function create_if_block_1$12(component, state) {
	...
	var if_block = (state.menu.items.length > 0) && create_if_block_2$6(component, state);
...
/* src\components\Menu.html generated by Svelte v1.56.0 */
...
function create_main_fragment$32(component, state) {
	...
	var if_block = (state.menus != null) && create_if_block$16(component, state);
...
function create_each_block$9(component, state) {
	var menu = state.menu, menu_index = state.menu_index;
	var li;
...
function create_if_block$16(component, state) {
	...
	for (var i = 0; i < menus.length; i += 1) {
		each_blocks[i] = create_each_block$9(component, assign({}, state, {
			menu: menus[i],
			menu_index: i
		}));
	}
...
/* src\components\Home.html generated by Svelte v1.56.0 */
