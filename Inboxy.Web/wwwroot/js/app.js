...
function create_main_fragment$21(component, state) {
	...
	var if_block = (state.data) && create_if_block$10(component, state);
...
function create_if_block_3$1(component, state) {
	...
	var if_block = (state.files && state.files.length >0) && create_if_block_4(component, state);
...
function create_main_fragment$19(component, state) {
	...
	var if_block = (state.documentation) && create_if_block$8(component, state);
...
function create_each_block$7(component, state) {
	var document_1 = state.document, document_index = state.document_index;
...
function create_if_block_2$3(component, state) {
	...
	for (var i = 0; i < outputFieldValues.length; i += 1) {
		each_blocks[i] = create_each_block_2$2(component, assign({}, state, {
...
function create_each_block$9(component, state) {
	...
	for (var i = 0; i < itemFields.length; i += 1) {
		each_blocks[i] = create_each_block_1$4(component, assign({}, state, {
...
function create_if_block_2$6(component, state) {
	...
	for (var i = 0; i < items.length; i += 1) {
		each_blocks[i] = create_each_block$11(component, assign({}, state, {
			submenu: items[i],
			submenu_index: i
		}));
	}
