...
function SvelteComponent$21(options) {
	...
	if (!document.getElementById("svelte-2561121021-style")) add_css$10();
...
function SvelteComponent$24(options) {
	...
	if (!document.getElementById("svelte-1971446092-style")) add_css$11();
...
function SvelteComponent$28(options) {
	...
	if (!document.getElementById("svelte-255426429-style")) add_css$12();
...
function select_block_type$7(state) {
	if (state.field.data.type == 'Text') return create_if_block$14;
...
function SvelteComponent$29(options) {
	...
	if (!document.getElementById("svelte-3186412805-style")) add_css$13();
...
controlRegister.registerOutputFieldControl("email-body", SvelteComponent$29, { block: true });
// Form event handlers.
...
function create_each_block$10(state, items, submenu, submenu_index, component) {
	...
	var sveltecomponent = new SvelteComponent$31({
		root: component.root,
		data: { menu: submenu }
	});
...
function select_block_type$8(state) {
	if (state.menu.url != null) return create_if_block$16;
...
function create_main_fragment$30(state, component) {
	...
	var if_block = (state.menus != null) && create_if_block$15(state, component);
		...
		p: function update(changed, state) {
			if (state.menus != null) {
				if (if_block) {
					...
					if_block = create_if_block$15(state, component);
					if_block.c();
					if_block.m(if_block_anchor.parentNode, if_block_anchor);
				}
			} else if (if_block) {
...
function create_each_block$9(state, menus, menu, menu_index, component) {
	...
	var menuitem = new SvelteComponent$31({
		root: component.root,
