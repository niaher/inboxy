...
/* src\core\ui\inputs\Text.html generated by Svelte v1.55.0 */
...
/* src\core\ui\inputs\Number.html generated by Svelte v1.55.0 */
...
/* src\core\ui\inputs\Date.html generated by Svelte v1.55.0 */
...
/* src\core\ui\inputs\Dropdown.html generated by Svelte v1.55.0 */
...
function create_each_block(state, items, option_1, option_index, component) {
	var option, text_value = option_1.label, text, option_value_value;
	...
	return {
		...
		h: function hydrate() {
			option.__value = option_value_value = option_1.value;
			option.value = option.__value;
		},
		...
		p: function update(changed, state, items, option_1, option_index) {
			if ((changed.field) && text_value !== (text_value = option_1.label)) {
				text.data = text_value;
			}

			if ((changed.field) && option_value_value !== (option_value_value = option_1.value)) {
...
/* src\core\ui\inputs\Boolean.html generated by Svelte v1.55.0 */
function encapsulateStyles(node) {
	setAttribute(node, "svelte-1287229296", "");
}

function add_css() {
	var style = createElement("style");
	style.id = 'svelte-1287229296-style';
	style.textContent = "[svelte-1287229296].checkbox,[svelte-1287229296] .checkbox{height:20px;width:20px;margin:0.6rem 0.5rem 1.1rem 0.5rem;overflow:initial;position:relative;clip:initial;-webkit-clip-path:initial;clip-path:initial;top:3px}";
...
function SvelteComponent$4(options) {
	...
	if (!document.getElementById("svelte-1287229296-style")) add_css();
...
/* src\core\ui\inputs\MultiSelect.html generated by Svelte v1.55.0 */
...
/* src\core\ui\inputs\Password.html generated by Svelte v1.55.0 */
...
/* src\core\ui\inputs\Textarea.html generated by Svelte v1.55.0 */
function encapsulateStyles$1(node) {
	setAttribute(node, "svelte-1133876753", "");
}

function add_css$1() {
	var style = createElement("style");
	style.id = 'svelte-1133876753-style';
	style.textContent = "textarea[svelte-1133876753],[svelte-1133876753] textarea{width:100%;height:100px}";
	appendNode(style, document.head);
}
...
function SvelteComponent$7(options) {
	...
	if (!document.getElementById("svelte-1133876753-style")) add_css$1();
...
/* src\core\ui\inputs\FileUploader.html generated by Svelte v1.55.0 */
var methods = {
	addFiles(files) {
		var field = this.get("field");
...
/* src\core\ui\outputs\Text.html generated by Svelte v1.55.0 */
...
/* src\core\ui\outputs\Number.html generated by Svelte v1.55.0 */
...
/* src\core\ui\outputs\Datetime.html generated by Svelte v1.55.0 */
function format(field) {
	var format = (field.metadata.customProperties || {}).format || "D MMM YYYY";

	var datetime = field.data;
	return datetime != null ? hooks(datetime).format(format) : "";
}

function create_main_fragment$11(state, component) {
	var text_value = format(state.field), text;
	...
	return {
		...
		p: function update(changed, state) {
			if ((changed.field) && text_value !== (text_value = format(state.field))) {
				text.data = text_value;
			}
		},
...
/* src\core\ui\Output.html generated by Svelte v1.55.0 */
function data() {
    return {
        showLabel: true
    };
...
function encapsulateStyles$3(node) {
	setAttribute(node, "svelte-3062429065", "");
}

function add_css$3() {
	var style = createElement("style");
	style.id = 'svelte-3062429065-style';
	style.textContent = "[svelte-3062429065].inline,[svelte-3062429065] .inline{display:inline-block\r\n    }";
	appendNode(style, document.head);
}
...
function SvelteComponent$13(options) {
	...
	if (!document.getElementById("svelte-3062429065-style")) add_css$3();
...
/* src\core\ui\outputs\Table.html generated by Svelte v1.55.0 */
...
function encapsulateStyles$2(node) {
	setAttribute(node, "svelte-2567078149", "");
}

function add_css$2() {
	var style = createElement("style");
	style.id = 'svelte-2567078149-style';
	style.textContent = "[svelte-2567078149].alert-nodata,[svelte-2567078149] .alert-nodata{padding:5px 15px;font-style:italic}[svelte-2567078149].table>tbody>tr>td .actionlist,[svelte-2567078149] .table>tbody>tr>td .actionlist{background:none;border:none;margin:0;padding:0;text-align:left}[svelte-2567078149].table,[svelte-2567078149] .table{border:1px solid #e5eff8}[svelte-2567078149].table thead th,[svelte-2567078149] .table thead th{border-bottom:1px solid #e5eff8;border-left:1px solid #e5eff8;font-weight:normal;background:#f4f9fe;color:#3f6e94}[svelte-2567078149].table tbody td,[svelte-2567078149] .table tbody td{border-top:1px solid #e9ecef;color:#678197;border-bottom:1px solid #e5eff8;border-left:1px solid #e5eff8}[svelte-2567078149].table tbody tr:nth-child(even) td,[svelte-2567078149] .table tbody tr:nth-child(even) td{background:#f4f9fe\r\n\t}[svelte-2567078149].table tbody tr:nth-child(odd) td,[svelte-2567078149] .table tbody tr:nth-child(odd) td{background:#FFF\r\n\t}";
	appendNode(style, document.head);
}
...
function create_each_block_2(state, data, row, row_index, columnsOrdered_1, column, column_index, component) {
	var td;
	...
	return {
		...
		p: function update(changed, state, data, row, row_index, columnsOrdered_1, column, column_index) {
...
function SvelteComponent$12(options) {
	...
	if (!document.getElementById("svelte-2567078149-style")) add_css$2();
...
/* src\core\ui\outputs\FormLink.html generated by Svelte v1.55.0 */
...
/* src\core\ui\outputs\Tabstrip.html generated by Svelte v1.55.0 */
...
function encapsulateStyles$4(node) {
	setAttribute(node, "svelte-398074703", "");
}

function add_css$4() {
	var style = createElement("style");
	style.id = 'svelte-398074703-style';
	style.textContent = "[svelte-398074703].tabstrip,[svelte-398074703] .tabstrip{margin:10px 0}[svelte-398074703].tabstrip>div,[svelte-398074703] .tabstrip>div{display:inline-block}[svelte-398074703].tabstrip>div>a,[svelte-398074703] .tabstrip>div>a{background:#eef3f7;border-width:1px 1px 1px 1px;border-style:solid;border-color:rgb(187, 210, 214);padding:10px 15px;margin:0 5px 0 0;display:inline-block;text-decoration:none;color:#838c98;font-weight:bold;border-radius:5px}[svelte-398074703].tabstrip>div>a:hover,[svelte-398074703] .tabstrip>div>a:hover{color:#f3818c}[svelte-398074703].tabstrip>div>a.active,[svelte-398074703] .tabstrip>div>a.active{margin-bottom:-1px;padding-bottom:11px;background:#fff;border-bottom:none;color:#3287c0;border-bottom-right-radius:3px;border-bottom-left-radius:3px}";
	appendNode(style, document.head);
}
...
function SvelteComponent$15(options) {
	...
	if (!document.getElementById("svelte-398074703-style")) add_css$4();
...
// (14:3) {{#each columnsOrdered as column}}
function create_each_block_2$1(state, data, row, row_index, columnsOrdered_1, column, column_index, component) {
	var td;
...
function SvelteComponent$17(options) {
	...
	if (!document.getElementById("svelte-2567078149-style")) add_css$6();
...
/* src\core\ui\outputs\Paginator.html generated by Svelte v1.55.0 */
...
function encapsulateStyles$5(node) {
	setAttribute(node, "svelte-3066407386", "");
}

function add_css$5() {
	var style = createElement("style");
	style.id = 'svelte-3066407386-style';
	style.textContent = "[svelte-3066407386].paginator,[svelte-3066407386] .paginator{margin:.5rem 0;padding-left:0}[svelte-3066407386].paginator>li,[svelte-3066407386] .paginator>li{display:inline-block}[svelte-3066407386].paginator>li>a,[svelte-3066407386] .paginator>li>a,[svelte-3066407386].paginator>li>button,[svelte-3066407386] .paginator>li>button{padding:2px 10px;margin:1px;display:inline-block;background:#eee}[svelte-3066407386].paginator>li>a.current,[svelte-3066407386] .paginator>li>a.current,[svelte-3066407386].paginator>li>button.current,[svelte-3066407386] .paginator>li>button.current{background:#1eb1c8;color:#fff}[svelte-3066407386].paginator>li>a:hover,[svelte-3066407386] .paginator>li>a:hover,[svelte-3066407386].paginator>li>button:hover,[svelte-3066407386] .paginator>li>button:hover{color:#f3818c;text-decoration:none\r\n\t}";
	appendNode(style, document.head);
}
...
function SvelteComponent$16(options) {
	...
	if (!document.getElementById("svelte-3066407386-style")) add_css$5();
...
/* src\core\ui\Input.html generated by Svelte v1.55.0 */
var inputId = 0;
...
function SvelteComponent$20(options) {
	...
	if (!document.getElementById("svelte-3062429065-style")) add_css$9();
...
/* src\core\ui\help\Help.html generated by Svelte v1.55.0 */
...
function encapsulateStyles$10(node) {
	setAttribute(node, "svelte-2878124489", "");
}

function add_css$10() {
	var style = createElement("style");
	style.id = 'svelte-2878124489-style';
	style.textContent = "ul[svelte-2878124489].help-files,[svelte-2878124489] ul.help-files{list-style:none}[svelte-2878124489].inline-help,[svelte-2878124489] .inline-help{background:#ecf8fb;padding:10px}[svelte-2878124489].modal-help > i,[svelte-2878124489] .modal-help > i{font-size:15pt;color:#f3818c}[svelte-2878124489].modal-help,[svelte-2878124489] .modal-help{display:inline;margin-left:-10px}[svelte-2878124489].help-files,[svelte-2878124489] .help-files{border-top:1px solid #d8d8d8;padding:10px;margin:10px;background:#ecf8fb}[svelte-2878124489].help-files ul,[svelte-2878124489] .help-files ul{list-style:circle}";
	appendNode(style, document.head);
}
...
function create_main_fragment$21(state, component) {
	...
	var if_block = (state.data) && create_if_block$10(state, component);
...
function create_each_block$8(state, files, file, file_index, component) {
	...
	return {
		...
		p: function update(changed, state, files, file, file_index) {
...
function create_if_block_2$4(state, component) {
	...
	for (var i = 0; i < files.length; i += 1) {
		each_blocks[i] = create_each_block$8(state, files, files[i], i, component);
	}
...
function create_each_block_1$3(state, files, file, file_index, component) {
	var li, a, text_value = file.name, text, a_href_value;
...
function create_if_block_4(state, component) {
	...
	for (var i = 0; i < files.length; i += 1) {
		each_blocks[i] = create_each_block_1$3(state, files, files[i], i, component);
	}
...
function create_if_block_1$8(state, component) {
	...
	var if_block = (state.files && state.files.length >0) && create_if_block_2$4(state, component);
	...
	return {
		...
		h: function hydrate() {
			...
			div.className = "help-content modal-help";
		},
...
function create_if_block_3$1(state, component) {
	...
	var if_block = (state.files && state.files.length >0) && create_if_block_4(state, component);
	...
	return {
		...
		h: function hydrate() {
			encapsulateStyles$10(div);
			div.className = "help-content inline-help";
		},
...
function select_block_type$7(state) {
	if (state.data.placement == 'Hint') return create_if_block_1$8;
...
function SvelteComponent$21(options) {
	...
	if (!document.getElementById("svelte-2878124489-style")) add_css$10();
...
assign(SvelteComponent$21.prototype, methods$4, proto);

/* src\core\ui\Form.html generated by Svelte v1.55.0 */
let tabindex = 1;
var openForms = [];
		...
		if (!this.get("initialized")) {
			...
			this.set({
				...
				submitButtonLabel: form.metadata.customProperties != null && form.metadata.customProperties.submitButtonLabel
					...
					: "Submit",
				documentation : form.metadata.customProperties != null && form.metadata.customProperties.documentation ?
				form.metadata.customProperties.documentation : null
			});
			tabindex += 1;
...
function encapsulateStyles$8(node) {
	setAttribute(node, "svelte-2876558560", "");
}

function add_css$8() {
	var style = createElement("style");
	style.id = 'svelte-2876558560-style';
	style.textContent = "[svelte-2876558560].response,[svelte-2876558560] .response{margin-top:15px;padding-left:10px;padding-right:10px}[svelte-2876558560].inline-form .response,[svelte-2876558560] .inline-form .response{margin-top:0;padding:10px 15px}[svelte-2876558560].inline-form h2,[svelte-2876558560] .inline-form h2{margin:0;background:#eee;padding:10px 15px 15px;font-size:15px}";
	appendNode(style, document.head);
}

function create_main_fragment$19(state, component) {
	var div, h2, text_value = state.responseMetadata.title || state.metadata.label, text, text_1, text_3, text_4, if_block_2_anchor;

	var if_block = (state.documentation) && create_if_block$8(state, component);

	var if_block_1 = (state.initialized && state.visibleInputFields.length > 0) && create_if_block_1$6(state, component);

	var if_block_2 = (state.outputFieldValues != null) && create_if_block_2$3(state, component);
		...
		p: function update(changed, state) {
			...
			if (state.outputFieldValues != null) {
				if (if_block_2) {
					...
					if_block_2 = create_if_block_2$3(state, component);
					if_block_2.c();
...
// (4:2) {{#each  documentation as document }}
function create_each_block$7(state, documentation, document_1, document_index, component) {

	var help = new SvelteComponent$21({
		root: component.root,
		data: { data: document_1 }
	});
	...
	return {
		...
		p: function update(changed, state, documentation, document_1, document_index) {
			var help_changes = {};
...
// (3:1) {{#if documentation }}
function create_if_block$8(state, component) {
	var each_anchor;

	var documentation = state.documentation;

	var each_blocks = [];

	for (var i = 0; i < documentation.length; i += 1) {
		each_blocks[i] = create_each_block$7(state, documentation, documentation[i], i, component);
	}
	...
	return {
		...
		p: function update(changed, state) {
			...
			if (changed.documentation) {
				for (var i = 0; i < documentation.length; i += 1) {
					if (each_blocks[i]) {
						each_blocks[i].p(changed, state, documentation, documentation[i], i);
					} else {
						each_blocks[i] = create_each_block$7(state, documentation, documentation[i], i, component);
						each_blocks[i].c();
						each_blocks[i].m(each_anchor.parentNode, each_anchor);
				...
				each_blocks.length = documentation.length;
			}
		},
...
// (13:1) {{#each visibleInputFields as inputField}}
function create_each_block_1$2(state, visibleInputFields, inputField, inputField_index, component) {
...
// (10:0) {{#if initialized && visibleInputFields.length > 0}}
function create_if_block_1$6(state, component) {
	...
	for (var i = 0; i < visibleInputFields.length; i += 1) {
		each_blocks[i] = create_each_block_1$2(state, visibleInputFields, visibleInputFields[i], i, component);
	}
...
// (24:1) {{#each outputFieldValues as outputField}}
function create_each_block_2$2(state, outputFieldValues, outputField, outputField_index, component) {
	var if_block_anchor;

	var if_block = (outputField.metadata.hidden == false) && create_if_block_3(state, outputFieldValues, outputField, outputField_index, component);
		...
		p: function update(changed, state, outputFieldValues, outputField, outputField_index) {
			if (outputField.metadata.hidden == false) {
				if (if_block) {
					...
					if_block = create_if_block_3(state, outputFieldValues, outputField, outputField_index, component);
					if_block.c();
					if_block.m(if_block_anchor.parentNode, if_block_anchor);
				}
			} else if (if_block) {
...
// (25:1) {{#if outputField.metadata.hidden == false}}
function create_if_block_3(state, outputFieldValues, outputField, outputField_index, component) {
...
// (22:0) {{#if outputFieldValues != null}}
function create_if_block_2$3(state, component) {
	...
	for (var i = 0; i < outputFieldValues.length; i += 1) {
		each_blocks[i] = create_each_block_2$2(state, outputFieldValues, outputFieldValues[i], i, component);
	}
...
function SvelteComponent$19(options) {
	...
	if (!document.getElementById("svelte-2876558560-style")) add_css$8();
...
/* src\core\ui\outputs\ActionList.html generated by Svelte v1.55.0 */
var modalId = 0;
var modals = [];
...
function encapsulateStyles$7(node) {
	setAttribute(node, "svelte-378642228", "");
}

function add_css$7() {
	var style = createElement("style");
	style.id = 'svelte-378642228-style';
	style.textContent = "[svelte-378642228].modal .card,[svelte-378642228] .modal .card{max-width:85%;padding:10px 15px}[svelte-378642228].hidden,[svelte-378642228] .hidden{width:0;height:0;position:absolute;left:-1000px}[svelte-378642228].actionlist,[svelte-378642228] .actionlist{margin:0px 0;padding:0 5px;text-align:right;background:#fff;margin-bottom:15px}[svelte-378642228].actionlist>li,[svelte-378642228] .actionlist>li{list-style-type:none;display:inline-block}";
	appendNode(style, document.head);
}
...
function SvelteComponent$18(options) {
	...
	if (!document.getElementById("svelte-378642228-style")) add_css$7();
...
/* src\core\ui\outputs\InlineForm.html generated by Svelte v1.55.0 */
function oncreate$7() {
	var app = this.get("app");
	var field = this.get("field");
	var parentFormComponent = this.get("parent");
...
function encapsulateStyles$11(node) {
	setAttribute(node, "svelte-2561121021", "");
}

function add_css$11() {
	var style = createElement("style");
	style.id = 'svelte-2561121021-style';
	style.textContent = "[svelte-2561121021].inline-form,[svelte-2561121021] .inline-form{border-width:1px 1px 1px;border-style:solid;border-color:#ccc;margin:30px 0;padding:1px 1px;border-radius:5px}";
	appendNode(style, document.head);
}
...
function SvelteComponent$22(options) {
	...
	if (!document.getElementById("svelte-2561121021-style")) add_css$11();
...
/* src\core\ui\outputs\TextValue.html generated by Svelte v1.55.0 */
...
/* src\core\ui\outputs\DownloadableFile.html generated by Svelte v1.55.0 */
...
/* src\core\ui\outputs\Alert.html generated by Svelte v1.55.0 */
function encapsulateStyles$12(node) {
	setAttribute(node, "svelte-1971446092", "");
}

function add_css$12() {
	var style = createElement("style");
	style.id = 'svelte-1971446092-style';
	style.textContent = "[svelte-1971446092].alert,[svelte-1971446092] .alert{margin:5px 8px;padding:10px 15px;border:1px solid #bbb}[svelte-1971446092].alert>.heading,[svelte-1971446092] .alert>.heading{font-weight:bold;font-size:16px}[svelte-1971446092].alert.success,[svelte-1971446092] .alert.success{background:#EBFFF8}[svelte-1971446092].alert.warning,[svelte-1971446092] .alert.warning{background:#FDFFEB}[svelte-1971446092].alert.danger,[svelte-1971446092] .alert.danger{background:#FFEAEA}";
	appendNode(style, document.head);
}
...
function create_if_block_1$9(state, component) {
...
function create_if_block$11(state, component) {
	...
	var if_block = (state.field.data.heading != null) && create_if_block_1$9(state, component);

	var if_block_1 = (state.field.data.message != null) && create_if_block_2$5(state, component);
		...
		p: function update(changed, state) {
			if (state.field.data.heading != null) {
				if (if_block) {
					...
					if_block = create_if_block_1$9(state, component);
					if_block.c();
					if_block.m(div, text);
				}
			} else if (if_block) {
			...
			if (state.field.data.message != null) {
				if (if_block_1) {
					...
					if_block_1 = create_if_block_2$5(state, component);
					if_block_1.c();
...
function SvelteComponent$25(options) {
	...
	if (!document.getElementById("svelte-1971446092-style")) add_css$12();
...
/* src\core\ui\outputs\FileSize.html generated by Svelte v1.55.0 */
...
/* src\core\ui\outputs\Image.html generated by Svelte v1.55.0 */
...
/* src\core\ui\outputs\Link.html generated by Svelte v1.55.0 */
function create_main_fragment$28(state, component) {
	var if_block_anchor;

	var if_block = (state.field.data != null) && create_if_block$13(state, component);
...
/* src\core\ui\outputs\ObjectList.html generated by Svelte v1.55.0 */
function oncreate$8() {
	var field = this.get("field");
...
function encapsulateStyles$13(node) {
	setAttribute(node, "svelte-255426429", "");
}

function add_css$13() {
	var style = createElement("style");
	style.id = 'svelte-255426429-style';
	style.textContent = "[svelte-255426429].object-list-item,[svelte-255426429] .object-list-item{margin:10px 0;border-bottom:1px solid #eee;padding:10px 0}";
	appendNode(style, document.head);
}
...
function create_main_fragment$29(state, component) {
	...
	var if_block = (state.items != null) && create_if_block$14(state, component);
...
function create_each_block$9(state, items, itemFields, itemFields_index, component) {
	var div;
	...
	for (var i = 0; i < itemFields_1.length; i += 1) {
		each_blocks[i] = create_each_block_1$4(state, items, itemFields, itemFields_index, itemFields_1, itemFields_1[i], i, component);
	}
...
function create_each_block_1$4(state, items, itemFields, itemFields_index, itemFields_1, itemField, itemField_index, component) {
	var if_block_anchor;

	var if_block = (itemField.metadata.hidden == false) && create_if_block_1$10(state, items, itemFields, itemFields_index, itemFields_1, itemField, itemField_index, component);
		...
		p: function update(changed, state, items, itemFields, itemFields_index, itemFields_1, itemField, itemField_index) {
			if (itemField.metadata.hidden == false) {
				if (if_block) {
					...
					if_block = create_if_block_1$10(state, items, itemFields, itemFields_index, itemFields_1, itemField, itemField_index, component);
					if_block.c();
					if_block.m(if_block_anchor.parentNode, if_block_anchor);
				}
			} else if (if_block) {
...
function create_if_block_1$10(state, items, itemFields, itemFields_index, itemFields_1, itemField, itemField_index, component) {
...
function create_if_block$14(state, component) {
	...
	for (var i = 0; i < items.length; i += 1) {
		each_blocks[i] = create_each_block$9(state, items, items[i], i, component);
	}
...
function SvelteComponent$29(options) {
	...
	if (!document.getElementById("svelte-255426429-style")) add_css$13();
...
/* src\core\ui\outputs\EmailBody.html generated by Svelte v1.55.0 */
function encapsulateStyles$14(node) {
	setAttribute(node, "svelte-3186412805", "");
}

function add_css$14() {
	var style = createElement("style");
	style.id = 'svelte-3186412805-style';
	style.textContent = "[svelte-3186412805].email-body,[svelte-3186412805] .email-body{margin:20px 0}";
	appendNode(style, document.head);
}
...
function create_main_fragment$30(state, component) {
	...
	var current_block_type = select_block_type$8(state);
	var if_block = current_block_type(state, component);
	...
	return {
		...
		p: function update(changed, state) {
			if (current_block_type === (current_block_type = select_block_type$8(state)) && if_block) {
				if_block.p(changed, state);
			} else {
				if_block.u();
				if_block.d();
...
// (2:0) {{#if field.data.type == 'Text'}}
function create_if_block$15(state, component) {
	var text_value = state.field.data.text, text;
	...
	return {
		...
		p: function update(changed, state) {
			if ((changed.field) && text_value !== (text_value = state.field.data.text)) {
				text.data = text_value;
			}
		},
...
// (4:0) {{else}}
function create_if_block_1$11(state, component) {
	var raw_value = state.field.data.text, raw_before, raw_after;
	...
	return {
		...
		p: function update(changed, state) {
			if ((changed.field) && raw_value !== (raw_value = state.field.data.text)) {
...
function select_block_type$8(state) {
	if (state.field.data.type == 'Text') return create_if_block$15;
...
function SvelteComponent$30(options) {
	...
	if (!document.getElementById("svelte-3186412805-style")) add_css$14();
...
/* src\core\ui\outputs\RawHtml.html generated by Svelte v1.55.0 */
function create_main_fragment$31(state, component) {
	var raw_value = state.field.data.content, raw_before, raw_after;
	...
	return {
		...
		p: function update(changed, state) {
			if ((changed.field) && raw_value !== (raw_value = state.field.data.content)) {
				detachBetween(raw_before, raw_after);
				raw_before.insertAdjacentHTML("afterend", raw_value);
			}
		},
...
controlRegister.registerOutputFieldControl("alert", SvelteComponent$25, { alwaysHideLabel: true, block: true });
controlRegister.registerOutputFieldControl("file-size", SvelteComponent$26);
controlRegister.registerOutputFieldControl("image", SvelteComponent$27, { block: true });
controlRegister.registerOutputFieldControl("link", SvelteComponent$28);
controlRegister.registerOutputFieldControl("object-list", SvelteComponent$29, { block: true });
controlRegister.registerOutputFieldControl("email-body", SvelteComponent$30, { block: true });
controlRegister.registerOutputFieldControl("raw-html", SvelteComponent$31, { block: true });
// Form event handlers.
...
/* src\components\MenuItem.html generated by Svelte v1.55.0 */
let id = 0;
function data$6() {
	return {
		id: id++
...
function create_main_fragment$33(state, component) {
	...
	var current_block_type = select_block_type$9(state);
	var if_block = current_block_type(state, component);
	...
	return {
		...
		p: function update(changed, state) {
			if (current_block_type === (current_block_type = select_block_type$9(state)) && if_block) {
				if_block.p(changed, state);
			} else {
				if_block.u();
				if_block.d();
...
function create_each_block$11(state, items, submenu, submenu_index, component) {
	var li;

	var sveltecomponent = new SvelteComponent$33({
		root: component.root,
		data: { menu: submenu }
	});
...
function create_if_block_2$6(state, component) {
	var ul;
	...
	for (var i = 0; i < items.length; i += 1) {
		each_blocks[i] = create_each_block$11(state, items, items[i], i, component);
	}
...
function create_if_block$17(state, component) {
...
// (3:0) {{else}}
function create_if_block_1$12(state, component) {
	var div, label, text_value = state.menu.id, text, label_for_value, text_2, input, input_id_value, text_3, if_block_anchor;

	var if_block = (state.menu.items.length > 0) && create_if_block_2$6(state, component);
		...
		p: function update(changed, state) {
			...
			if (state.menu.items.length > 0) {
				if (if_block) {
					...
					if_block = create_if_block_2$6(state, component);
					if_block.c();
					if_block.m(if_block_anchor.parentNode, if_block_anchor);
				}
			} else if (if_block) {
...
function select_block_type$9(state) {
	if (state.menu.url != null) return create_if_block$17;
...
/* src\components\Menu.html generated by Svelte v1.55.0 */
...
function create_main_fragment$32(state, component) {
	...
	var if_block = (state.menus != null) && create_if_block$16(state, component);
		...
		p: function update(changed, state) {
			if (state.menus != null) {
				if (if_block) {
					...
					if_block = create_if_block$16(state, component);
					if_block.c();
					if_block.m(if_block_anchor.parentNode, if_block_anchor);
				}
			} else if (if_block) {
...
function create_each_block$10(state, menus, menu, menu_index, component) {
	var li;

	var menuitem = new SvelteComponent$33({
		root: component.root,
...
// (1:0) {{#if menus != null}}
function create_if_block$16(state, component) {
	var ul;
	...
	for (var i = 0; i < menus.length; i += 1) {
		each_blocks[i] = create_each_block$10(state, menus, menus[i], i, component);
	}
...
/* src\components\Home.html generated by Svelte v1.55.0 */
...
var AppRouter = (function () {
    function AppRouter(element, app) {
        ...
        this.stateRouter.addState({
            ...
            data: {},
            route: "/home",
            template: SvelteComponent$34
        });
        var self = this;
        this.stateRouter.addState({
            name: "menu",
            route: "/menu",
            template: SvelteComponent$32,
